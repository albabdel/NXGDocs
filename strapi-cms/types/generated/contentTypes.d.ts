...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    documentation_articles: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiDocumentationArticleDocumentationArticle
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    device_type: Schema.Attribute.Enumeration<
      [
        'hikvision',
        'dahua',
        'adpro',
    ...
    > &
      Schema.Attribute.Private;
    order: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    platform: Schema.Attribute.Enumeration<['gcxone', 'talos', 'both']> &
      Schema.Attribute.DefaultTo<'both'>;
    publishedAt: Schema.Attribute.DateTime;
    role: Schema.Attribute.Enumeration<
      ['admin', 'operator', 'installer', 'manager', 'all']
    > &

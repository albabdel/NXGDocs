...
import { Headphones, Shield, AlertCircle, RefreshCw, Wifi, UserX, Lock, Clock, Server, Ticket, MessageSquare, CheckCircle, ArrowRight } from 'lucide-react';
...
export default function LoginScreen({ onLogin, isDark, loginError, retrying, onClearError }: Props) {
  ...
  const borderColor = isDark ? 'rgba(59,130,246,0.2)' : 'rgba(59,130,246,0.3)';
    ...
    <div className="flex flex-col items-center justify-center min-h-[60vh] px-6">
      ...
      >
        <div
          ...
          style={{
            background: 'linear-gradient(90deg, transparent 0%, #3b82f6 30%, #1d4ed8 50%, #3b82f6 70%, transparent 100%)',
          }}
        />
        ...
        >
          <Headphones className="w-8 h-8" style={{ color: '#3b82f6' }} />
        </div>
        ...
        {loginError && (
          <div
            ...
            style={{
              background: loginError.retryable ? 'rgba(245,158,11,0.08)' : 'rgba(239,68,68,0.08)',
              border: loginError.retryable ? '1px solid rgba(245,158,11,0.25)' : '1px solid rgba(239,68,68,0.25)',
            }}
          >
            ...
            <div className="flex-1">
              <p className="text-sm font-semibold mb-1" style={{ color: getErrorMeta(loginError.type).color }}>
              ...
              <p className="text-sm mb-2" style={{ color: 'var(--ifm-color-content)' }}>
                {loginError.message}
              </p>
              {loginError.action && (
        ...
        >
          {retrying ? (
            ...
            <>
              ...
              <span className="text-base">Sign in with Auth0</span>

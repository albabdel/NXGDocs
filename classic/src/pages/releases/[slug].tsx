...
export default function ReleaseDetailPage({ slug }: Props) {
    const releases: ReleasesArray = releasesData;
    
    // Find matching release
    const release = releases.find(r => r.slug?.current === slug);
    ...
    const changeTypeConfig_item = changeTypeConfig;
                    ...
                    >
                        ...
                        <div className="space-y-6">
                            {release.items.map((item, idx) => {
                                const typeConfig = item.changeType ? changeTypeConfig_item[item.changeType] : null;
                    ...
                    >
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            ...
                            {Object.entries(
                                ...
                                const config = changeTypeConfig_item[type];
                                return (

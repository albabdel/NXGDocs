...
// Types for roadmap data from Sanity
...
// Expandable Roadmap Item Card Component
                ...
                {isExpanded && (
                    ...
                    >
                        <div className={`p-6 space-y-6 ${isDark ? 'bg-[#1a1a1a]' : 'bg-gray-50'}`}>
                            ...
                            {/* Release Link for Shipped Items */}
...
// Get the latest update date from roadmap items
...
export default function RoadmapPage(): JSX.Element {
    ...
    // Handle card toggle (accordion behavior - one at a time)

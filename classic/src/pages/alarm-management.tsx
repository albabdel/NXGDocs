...
const alarmFeatures: AlarmFeature[] = [
    // Core Alarm Processing
    {
        ...
        description: 'Centralized queue displaying all active alarms with priority sorting, filtering, and instant acknowledgement capabilities.',
        category: 'Core Processing',
        link: '/docs/alarm-management/alarm-queue',
        icon: <Bell className="w-6 h-6" />,
        status: 'core'
    },
    {
        title: 'Alarm Prioritization',
        description: 'Multi-level priority system (Critical, High, Medium, Low) with visual indicators and automatic sorting for efficient triage.',
        category: 'Core Processing',
        link: '/docs/alarm-management/alarm-prioritization',
        icon: <Target className="w-6 h-6" />,
        status: 'core'
    },
    {
        title: 'Alarm Actions',
        description: 'Comprehensive action toolkit: acknowledge, dismiss, escalate, snooze, reassign, and add operator notes for each alarm.',
        category: 'Core Processing',
        link: '/docs/alarm-management/alarm-actions',
        icon: <CheckSquare className="w-6 h-6" />,
        status: 'core'
    },
    {
        title: 'Alarm Verification',
        description: 'Built-in verification tools including video clip review, live view access, and event context to validate alarm authenticity.',
        category: 'Core Processing',
        link: '/docs/alarm-management/alarm-verification',
        icon: <CheckCircle2 className="w-6 h-6" />,
        status: 'core'
    },
    {
        title: 'Alarm Filtering',
        description: 'Advanced filtering by priority, status, site, device type, time range, and custom criteria for rapid alarm location.',
        category: 'Core Processing',
    ...
    // Routing & Escalation
    {
        ...
        description: 'Intelligent routing engine directing alarms to specific operators, teams, or queues based on site, device, priority, or time.',
        category: 'Routing & Escalation',
        link: '/docs/alarm-management/alarm-routing',
        icon: <Route className="w-6 h-6" />,
        status: 'advanced'
    },
    {
        title: 'Escalation Rules',
        description: 'Automated escalation workflows triggering supervisor notifications and actions when alarms remain unaddressed beyond defined timeframes.',
        category: 'Routing & Escalation',
        link: '/docs/alarm-management/escalation-rules',
    ...
    },
    {
        ...
        category: 'Routing & Escalation',
        link: '/docs/alarm-management/multi-site-alarms',
    ...
    // Notifications & Integration
    {
        ...
        description: 'Multi-channel notification system delivering alarm alerts via email, SMS, push notifications, and audio alerts to operators.',
        category: 'Notifications & Integration',
        link: '/docs/alarm-management/alarm-notifications',
        icon: <Volume2 className="w-6 h-6" />,
        status: 'core'
    },
    {
        title: 'Third-Party Integration',
        description: 'Webhook-based integration with external monitoring stations, incident management systems, and PSIM platforms for alarm forwarding.',
        category: 'Notifications & Integration',
        link: '/docs/alarm-management/alarm-integration',
    ...
    {
        title: 'Alarm History',
        description: 'Complete historical record of all alarms with timestamps, operator actions, resolution status, and forensic audit trails.',
        category: 'Analytics & Reporting',
        link: '/docs/alarm-management/alarm-history',
        icon: <Clock className="w-6 h-6" />,
        status: 'core'
    },
    {
        title: 'Alarm Metrics',
        description: 'Real-time metrics dashboard tracking alarm volume, response times, false alarm rates, and operator performance KPIs.',
        category: 'Analytics & Reporting',
        link: '/docs/alarm-management/alarm-metrics',
        icon: <BarChart3 className="w-6 h-6" />,
        status: 'advanced'
    },
    {
        title: 'Alarm Reporting',
        description: 'Comprehensive reporting suite with scheduled reports, custom date ranges, site comparisons, and trend analysis for operational insights.',
        category: 'Analytics & Reporting',
        link: '/docs/alarm-management/alarm-reporting',
        icon: <FileText className="w-6 h-6" />,
        status: 'advanced'
    },
    {
        title: 'SLA Monitoring',
        description: 'Service Level Agreement tracking ensuring alarm response and resolution times meet contractual commitments with automatic alerts.',
        category: 'Analytics & Reporting',
        link: '/docs/alarm-management/alarm-sla',
    ...
    // Optimization & Training
    {
        ...
        description: 'False alarm reduction toolkit with pattern detection, device tuning recommendations, and threshold adjustment guidance.',
        category: 'Optimization & Training',
        link: '/docs/alarm-management/false-alarms',
        icon: <AlertTriangle className="w-6 h-6" />,
        status: 'advanced'
    },
    {
        title: 'Operator Training',
        description: 'Interactive training modules and best practices library for alarm handling, verification procedures, and escalation protocols.',
        category: 'Optimization & Training',
        link: '/docs/alarm-management/operator-training',
        icon: <UserCheck className="w-6 h-6" />,
        status: 'core'
    },
    {
        title: 'Alarm Best Practices',
        description: 'Comprehensive guide covering alarm handling workflows, response procedures, communication protocols, and quality standards.',
        category: 'Optimization & Training',
        link: '/docs/alarm-management/alarm-best-practices',
    ...
    // System Health & Performance
    {
        ...
        description: 'Proactive monitoring of alarm system health including device connectivity, event reception rates, and system performance indicators.',
        category: 'System Health & Performance',
        link: '/docs/alarm-management/system-health',
        icon: <Activity className="w-6 h-6" />,
        status: 'advanced'
    },
    {
        title: 'Troubleshooting Guide',
        description: 'Step-by-step troubleshooting procedures for common alarm issues including missed alarms, delayed notifications, and integration problems.',
        category: 'System Health & Performance',
        link: '/docs/alarm-management/alarm-troubleshooting',
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                ...
                >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {[
                            {
                                title: 'Alarm Queue Dashboard',
                                description: 'Access the centralized alarm monitoring interface',
                                icon: <Bell className="w-6 h-6" />,
                                link: '/docs/alarm-management/alarm-queue',
                            },
                            {
                                title: 'Setup Routing Rules',
                                description: 'Configure intelligent alarm routing and escalation',
                                icon: <Route className="w-6 h-6" />,
                                link: '/docs/alarm-management/alarm-routing',
                            },
                            {
                                title: 'Operator Training',
                                description: 'Learn best practices for alarm handling',
                                icon: <UserCheck className="w-6 h-6" />,
                                link: '/docs/alarm-management/operator-training',
                            },
                        ].map((resource, index) => (

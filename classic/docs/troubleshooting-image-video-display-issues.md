---
id: "troubleshooting-image-video-display-issues"
title: "Image and Video Display Issues"
slug: "troubleshooting-image-video-display-issues"
description: "Complete troubleshooting guide for alarm images, video playback, and display issues in Genesis"
---

# Image and Video Display Issues

This guide covers three common image and video display issues in Genesis:
1. Alarm images from incorrect sites/NVRs
2. Alarms with no image / empty alarm images
3. Live view or playback not working
...
- [Time Synchronization Errors](/docs/troubleshooting/time-synchronization-errors)
- [Local Mode Overview](/docs/features/local-mode/overview)
- [Playback Overview](/docs/features/playback/overview)
- [Live View Overview](/docs/features/live-view/overview)
- [Redundancy Filter](/docs/installer-guide/redundancy-failover)

## Need Help?

If you continue to experience image or video display issues after following these troubleshooting steps, contact [GCXONE Support](/docs/support) with:

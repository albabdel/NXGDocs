...
### 3. Settings & Address
Scroll to the **Address** pane to enter the physical location. Ensure this exact address is used for [GCXONE-Talos Sync](/docs/getting-started/gcxone-talos-interaction).
...
**Next:** [Managing Users & Role Permissions](/docs/admin-guide/user-management)

...
- **Video Tutorials:** Access [Training Videos](/docs/support/training-resources)
- **Community Forum:** Join discussions at [GCXONE Community](/docs/support/community-forum)
...
3. **Customize Your Dashboard** - Learn [Dashboard Customization](/docs/admin-guide/dashboard-overview)
4. **Invite Your Team** - Complete user setup with [Team Onboarding](/docs/admin-guide/user-management)

...
<RelatedArticles articles={[
  {
    ...
    url: "/docs/getting-started/talos/workflows",
    description: "Configuring logic for your sites."
  },
  {
...
**Next:** [Troubleshooting Talos Sync Errors](/docs/getting-started/talos/troubleshooting-time-synchronization-errors)

...
<Tabs defaultValue="core">
  <TabItem value="core" label="Core Platform">
  ...
  <TabItem value="auth" label="Authentication & Security">
    - `nxgen.eu.auth0.com`
    - `cdn.auth0.com`
    - `sitasys-prod.eu.auth0.com`
  </TabItem>
  <TabItem value="assets" label="Media & Maps">
  ...
  <TabItem value="comm" label="Communication">
    - `sdk.twilio.com`

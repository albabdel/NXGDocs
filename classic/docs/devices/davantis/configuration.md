---
title: "Davantis AI BOX Configuration"
description: "Step-by-step configuration guide for Davantis AI BOX integration with GCXONE"
tags:
  - role:installer
...
# Davantis AI BOX Configuration

## Overview

This guide covers the complete configuration of Davantis AI BOX integration with GCXONE, including both device-side and platform-side setup.

**What you'll accomplish:**
- Configure Davantis AI BOX for communication with GCXONE
...
**Objective**: Ensure Davantis AI BOX can communicate with GCXONE platform.
...
**Objective**: Register the Davantis AI BOX in GCXONE platform.
...
**UI Path**: GCXONE → Devices → Davantis AI BOX → Settings
...
- [Davantis AI BOX Overview](./overview.md)
- [Davantis AI BOX Troubleshooting](./troubleshooting.md)

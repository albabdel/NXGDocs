---
title: "Rosenberger IOT battery Mgmt Overview"
description: "Integration guide for Rosenberger IOT battery Mgmt with GCXONE"
tags:
  - role:installer
...
- [ ] Network connectivity between Rosenberger IOT battery Mgmt and GCXONE platform
...
To configure Rosenberger IOT battery Mgmt with GCXONE, follow these main steps:
...
- [Rosenberger IOT battery Mgmt Configuration](./configuration.md)
...
If you need assistance with Rosenberger IOT battery Mgmt integration, check our [Troubleshooting Guide](./troubleshooting.md) or [contact support](/docs/troubleshooting-support/how-to-submit-a-support-ticket).

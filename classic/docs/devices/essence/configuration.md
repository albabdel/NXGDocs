---
title: "Essence My Sheild PIR CAM Configuration"
description: "Step-by-step configuration guide for Essence My Sheild PIR CAM integration with GCXONE"
tags:
  - role:installer
...
# Essence My Sheild PIR CAM Configuration

## Overview

This guide covers the complete configuration of Essence My Sheild PIR CAM integration with GCXONE, including both device-side and platform-side setup.

**What you'll accomplish:**
- Configure Essence My Sheild PIR CAM for communication with GCXONE
...
**Objective**: Ensure Essence My Sheild PIR CAM can communicate with GCXONE platform.
...
**Objective**: Register the Essence My Sheild PIR CAM in GCXONE platform.
...
**UI Path**: GCXONE → Devices → Essence My Sheild PIR CAM → Settings
...
- [Essence My Sheild PIR CAM Overview](./overview.md)
- [Essence My Sheild PIR CAM Troubleshooting](./troubleshooting.md)

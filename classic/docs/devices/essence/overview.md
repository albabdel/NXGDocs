---
title: "Essence My Sheild PIR CAM Overview"
description: "Integration guide for Essence My Sheild PIR CAM with GCXONE"
tags:
  - role:installer
...
- [ ] Network connectivity between Essence My Sheild PIR CAM and GCXONE platform
...
To configure Essence My Sheild PIR CAM with GCXONE, follow these main steps:
...
- [Essence My Sheild PIR CAM Configuration](./configuration.md)
...
If you need assistance with Essence My Sheild PIR CAM integration, check our [Troubleshooting Guide](./troubleshooting.md) or [contact support](/docs/troubleshooting-support/how-to-submit-a-support-ticket).

---
title: "Axis IP Camera Configuration"
description: "Step-by-step configuration guide for Axis IP Camera integration with GCXONE"
tags:
  - role:installer
...
# Axis IP Camera Configuration

## Overview

This guide covers the complete configuration of Axis IP Camera integration with GCXONE, including both device-side and platform-side setup.

**What you'll accomplish:**
- Configure Axis IP Camera for communication with GCXONE
...
**Objective**: Ensure Axis IP Camera can communicate with GCXONE platform.
...
**Objective**: Register the Axis IP Camera in GCXONE platform.
...
**UI Path**: GCXONE → Devices → Axis IP Camera → Settings

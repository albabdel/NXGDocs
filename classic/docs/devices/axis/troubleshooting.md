---
title: "Axis IP Camera Troubleshooting"
description: "Troubleshooting guide for Axis IP Camera integration with GCXONE"
tags:
  - role:installer
  - role:support
...
# Axis IP Camera Troubleshooting

## Overview

This guide covers common issues and solutions for Axis IP Camera integration with GCXONE. Use this guide to diagnose and resolve problems during installation, configuration, and operation.
...
4. Check stream encoding settings:
   ...
   - **Bitrate**: Variable (VBR) or constant (CBR)
...
2. Configure GCXONE receiver details:
   - **Protocol**: HTTPS Webhook / VAPIX
   - **IP Address**: https://acsproxy.nxgen.cloud/eventIngest
   - **Port**: 443
   - **Account Number**: Generated Device Unique Number
...
Most ip camera devices include diagnostic tools:
...
- [Axis IP Camera Overview](./overview.md)

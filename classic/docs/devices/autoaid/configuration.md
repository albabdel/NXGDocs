---
title: "Autoaid IOT Configuration"
description: "Step-by-step configuration guide for Autoaid IOT integration with GCXONE"
tags:
  - role:installer
...
# Autoaid IOT Configuration

## Overview

This guide covers the complete configuration of Autoaid IOT integration with GCXONE, including both device-side and platform-side setup.

**What you'll accomplish:**
- Configure Autoaid IOT for communication with GCXONE
...
**Objective**: Ensure Autoaid IOT can communicate with GCXONE platform.
...
**Objective**: Register the Autoaid IOT in GCXONE platform.
...
**UI Path**: GCXONE → Devices → Autoaid IOT → Settings
...
- [Autoaid IOT Overview](./overview.md)
- [Autoaid IOT Troubleshooting](./troubleshooting.md)

---
title: "Autoaid IOT Overview"
description: "Integration guide for Autoaid IOT with GCXONE"
tags:
  - role:installer
...
- [ ] Network connectivity between Autoaid IOT and GCXONE platform
...
To configure Autoaid IOT with GCXONE, follow these main steps:
...
- [Autoaid IOT Configuration](./configuration.md)
...
If you need assistance with Autoaid IOT integration, check our [Troubleshooting Guide](./troubleshooting.md) or [contact support](/docs/troubleshooting-support/how-to-submit-a-support-ticket).

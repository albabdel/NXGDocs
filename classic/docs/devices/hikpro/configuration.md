---
title: "Hikpro P2P Cloud VMS Configuration"
description: "Step-by-step configuration guide for Hikpro P2P Cloud VMS integration with GCXONE"
tags:
  - role:installer
...
# Hikpro P2P Cloud VMS Configuration

## Overview

This guide covers the complete configuration of Hikpro P2P Cloud VMS integration with GCXONE, including both device-side and platform-side setup.

**What you'll accomplish:**
- Configure Hikpro P2P Cloud VMS for communication with GCXONE
...
**Objective**: Ensure Hikpro P2P Cloud VMS can communicate with GCXONE platform.
...
**Objective**: Register the Hikpro P2P Cloud VMS in GCXONE platform.
...
**UI Path**: GCXONE → Devices → Hikpro P2P Cloud VMS → Settings
...
- [Hikpro P2P Cloud VMS Overview](./overview.md)
- [Hikpro P2P Cloud VMS Troubleshooting](./troubleshooting.md)

---
title: "Miwi Urmet (Polish) NVR/IP Camera Overview"
description: "Integration guide for Miwi Urmet (Polish) NVR/IP Camera with GCXONE"
tags:
  - role:installer
...
# Miwi Urmet (Polish) NVR/IP Camera
...
- [ ] Network connectivity between Miwi Urmet (Polish) NVR/IP Camera and GCXONE platform
...
To configure Miwi Urmet (Polish) NVR/IP Camera with GCXONE, follow these main steps:
...
If you need assistance with Miwi Urmet (Polish) NVR/IP Camera integration, check our [Troubleshooting Guide](./troubleshooting.md) or [contact support](/docs/troubleshooting-support/how-to-submit-a-support-ticket).

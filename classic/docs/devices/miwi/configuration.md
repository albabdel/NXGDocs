---
title: "Miwi Urmet (Polish) NVR/IP Camera Configuration"
description: "Step-by-step configuration guide for Miwi Urmet (Polish) NVR/IP Camera integration with GCXONE"
tags:
  - role:installer
...
# Miwi Urmet (Polish) NVR/IP Camera Configuration

## Overview

This guide covers the complete configuration of Miwi Urmet (Polish) NVR/IP Camera integration with GCXONE, including both device-side and platform-side setup.

**What you'll accomplish:**
- Configure Miwi Urmet (Polish) NVR/IP Camera for communication with GCXONE
...
**Objective**: Ensure Miwi Urmet (Polish) NVR/IP Camera can communicate with GCXONE platform.
...
**Objective**: Register the Miwi Urmet (Polish) NVR/IP Camera in GCXONE platform.
...
**UI Path**: GCXONE → Devices → Miwi Urmet (Polish) NVR/IP Camera → Settings
...
- [Miwi Urmet (Polish) NVR/IP Camera Troubleshooting](./troubleshooting.md)

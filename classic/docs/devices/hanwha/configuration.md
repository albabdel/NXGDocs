---
title: "HANWHA Configuration"
description: "Step-by-step configuration guide for HANWHA integration with GCXONE"
tags:
  - role:installer
...
# HANWHA Configuration

## Overview

This guide covers the complete configuration of HANWHA integration with GCXONE, including both device-side and platform-side setup.

**What you'll accomplish:**
- Configure HANWHA for communication with GCXONE
...
**Objective**: Ensure HANWHA can communicate with GCXONE platform.
...
**Objective**: Register the HANWHA in GCXONE platform.
...
**UI Path**: GCXONE → Devices → HANWHA → Settings
...
- [HANWHA Overview](./overview.md)
- [HANWHA Troubleshooting](./troubleshooting.md)

---
title: "Axxon VMS Configuration"
description: "Step-by-step configuration guide for Axxon VMS integration with GCXONE"
tags:
  - role:installer
...
# Axxon VMS Configuration

## Overview

This guide covers the complete configuration of Axxon VMS integration with GCXONE, including both device-side and platform-side setup.

**What you'll accomplish:**
- Configure Axxon VMS for communication with GCXONE
...
**Objective**: Ensure Axxon VMS can communicate with GCXONE platform.
...
**Objective**: Register the Axxon VMS in GCXONE platform.
...
**UI Path**: GCXONE → Devices → Axxon VMS → Settings
...
- [Axxon VMS Overview](./overview.md)
- [Axxon VMS Troubleshooting](./troubleshooting.md)

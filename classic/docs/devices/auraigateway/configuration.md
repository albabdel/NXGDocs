---
title: "Auraigateway IOT Mining Configuration"
description: "Step-by-step configuration guide for Auraigateway IOT Mining integration with GCXONE"
tags:
  - role:installer
...
# Auraigateway IOT Mining Configuration

## Overview

This guide covers the complete configuration of Auraigateway IOT Mining integration with GCXONE, including both device-side and platform-side setup.

**What you'll accomplish:**
- Configure Auraigateway IOT Mining for communication with GCXONE
...
**Objective**: Ensure Auraigateway IOT Mining can communicate with GCXONE platform.
...
**Objective**: Register the Auraigateway IOT Mining in GCXONE platform.
...
**UI Path**: GCXONE → Devices → Auraigateway IOT Mining → Settings
...
- [Auraigateway IOT Mining Overview](./overview.md)
- [Auraigateway IOT Mining Troubleshooting](./troubleshooting.md)

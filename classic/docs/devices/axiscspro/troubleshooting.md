---
title: "AXIS CS Pro VMS Troubleshooting"
description: "Troubleshooting guide for AXIS CS Pro VMS integration with GCXONE"
tags:
  - role:installer
  - role:support
...
# AXIS CS Pro VMS Troubleshooting

## Overview

This guide covers common issues and solutions for AXIS CS Pro VMS integration with GCXONE. Use this guide to diagnose and resolve problems during installation, configuration, and operation.
...
1. Check that ports **29202 (TCP)**, **29204 (API)**, and **29205 (Streaming)** are open on the ACS server firewall.
2. Verify GCXONE IP/network is whitelisted on the server.
3. Check network firewall rules between the VMS server and the cloud proxy.

**Expected Result**: ACS Pro server is discovered, and registration is successful.
...
2. Configure GCXONE receiver details:
   - **Protocol**: HTTPS / VAPIX
   - **IP Address**: https://acsproxy.nxgen.cloud/eventIngest
   - **Port**: 443
   - **Account Number**: ACS Device Unique Number from GCXONE
...
Most vms devices include diagnostic tools:

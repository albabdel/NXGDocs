---
title: "Heitel NVR Configuration"
description: "Step-by-step configuration guide for Heitel NVR integration with GCXONE"
tags:
  - role:installer
...
# Heitel NVR Configuration

## Overview

This guide covers the complete configuration of Heitel NVR integration with GCXONE, including both device-side and platform-side setup.

**What you'll accomplish:**
- Configure Heitel NVR for communication with GCXONE
...
**Objective**: Ensure Heitel NVR can communicate with GCXONE platform.
...
**Objective**: Register the Heitel NVR in GCXONE platform.
...
**UI Path**: GCXONE → Devices → Heitel NVR → Settings
...
- [Heitel NVR Overview](./overview.md)
- [Heitel NVR Troubleshooting](./troubleshooting.md)

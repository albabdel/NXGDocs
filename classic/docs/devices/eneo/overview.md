---
title: "ENEO NVR Overview"
description: "Integration guide for ENEO NVR with GCXONE"
tags:
  - role:installer
...
- **Purpose**: Professional NVR with GCXONE cloud integration for multi-site video management and monitoring.
- **Outcome**: Cloud connectivity with live streaming, playback, PTZ, timeline view, and comprehensive monitoring.
...
- **Event Types**: Motion detection, video loss, disk full, system alerts, I/O triggers, tampering
...
| | 4K/High Resolution | ✓ | Supports high-resolution cameras |
...
To configure ENEO NVR with GCXONE, follow these main steps:
...
3. **Add to GCXONE Platform** - Log into GCXONE and add the ENEO NVR using IP address and credentials
...
- [ENEO NVR Configuration](./configuration.md)
...
If you need assistance with ENEO NVR integration, check our [Troubleshooting Guide](./troubleshooting.md) or [contact support](/docs/troubleshooting-support/how-to-submit-a-support-ticket).

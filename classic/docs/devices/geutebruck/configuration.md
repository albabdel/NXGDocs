---
title: "Geutebrück VMS Configuration"
description: "Step-by-step configuration guide for Geutebrück VMS integration with GCXONE"
tags:
  - role:installer
...
# Geutebrück VMS Configuration

## Overview

This guide covers the complete configuration of Geutebrück VMS integration with GCXONE, including both device-side and platform-side setup.

**What you'll accomplish:**
- Configure Geutebrück VMS for communication with GCXONE
...
**Objective**: Ensure Geutebrück VMS can communicate with GCXONE platform.
...
**Objective**: Register the Geutebrück VMS in GCXONE platform.
...
**UI Path**: GCXONE → Devices → Geutebrück VMS → Settings
...
- [Geutebrück VMS Overview](./overview.md)
- [Geutebrück VMS Troubleshooting](./troubleshooting.md)

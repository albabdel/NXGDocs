---
title: "EFOY Router Configuration"
description: "Step-by-step configuration guide for EFOY Router integration with GCXONE"
tags:
  - role:installer
...
# EFOY Router Configuration

## Overview

This guide covers the complete configuration of EFOY Router integration with GCXONE, including both device-side and platform-side setup.

**What you'll accomplish:**
- Configure EFOY Router for communication with GCXONE
...
**Objective**: Ensure EFOY Router can communicate with GCXONE platform.
...
**Objective**: Register the EFOY Router in GCXONE platform.
...
**UI Path**: GCXONE → Devices → EFOY Router → Settings
...
- [EFOY Router Overview](./overview.md)
- [EFOY Router Troubleshooting](./troubleshooting.md)

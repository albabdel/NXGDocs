---
title: "EFOY Router Overview"
description: "Integration guide for EFOY Router with GCXONE"
tags:
  - role:installer
...
- [ ] Network connectivity between EFOY Router and GCXONE platform
...
To configure EFOY Router with GCXONE, follow these main steps:
...
- [EFOY Router Configuration](./configuration.md)
...
If you need assistance with EFOY Router integration, check our [Troubleshooting Guide](./troubleshooting.md) or [contact support](/docs/troubleshooting-support/how-to-submit-a-support-ticket).

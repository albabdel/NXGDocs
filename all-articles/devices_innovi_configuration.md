---
title: "Innovi AI Cloud Configuration"
description: "Step-by-step configuration guide for Innovi AI Cloud integration with GCXONE"
tags:
  - role:installer
...
# Innovi AI Cloud Configuration

## Overview

This guide covers the complete configuration of Innovi AI Cloud integration with GCXONE, including both device-side and platform-side setup.

**What you'll accomplish:**
- Configure Innovi AI Cloud for communication with GCXONE
...
**Objective**: Ensure Innovi AI Cloud can communicate with GCXONE platform.
...
**Objective**: Register the Innovi AI Cloud in GCXONE platform.
...
**UI Path**: GCXONE → Devices → Innovi AI Cloud → Settings
...
- Innovi AI Cloud Troubleshooting
- 
- 

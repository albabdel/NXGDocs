...
| :--- | :--- | :--- |
| **Role Cloning** | Clone existing roles including all entities and privileges. Cloned roles are independent of originals. | March 2026 |
| **Hierarchical Entity Selection** | Entity tree supports parent-child selection. Selecting parent auto-selects all children. | March 2026 |
| **Dynamic Privilege Filtering** | Privilege list filters dynamically based on selected entities. Only relevant privileges are visible. | March 2026 |
| **Effective Permissions View** | View user's effective permissions showing direct roles, group roles, and merged permissions. | March 2026 |
| **Bulk Role Assignment** | Assign roles to groups. All group members receive the role immediately. | March 2026 |

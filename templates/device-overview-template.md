...
description: "Integration guide for [Device Name] with GCXONE"
tags:
  - role:installer
...
- [ ] Network connectivity between [device] and GCXONE platform
...
To configure [Device Name] with GCXONE, follow these main steps:
...
- [YYYY-MM-DD] v1.0.0 - Initial GCXONE documentation

---

**Need Help?**

If you need assistance with [Device Name] integration, check our [Troubleshooting Guide](./troubleshooting.md) or [contact support](/docs/troubleshooting-support/how-to-submit-a-support-ticket).

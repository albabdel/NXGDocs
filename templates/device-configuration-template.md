...
description: "Step-by-step configuration guide for [Device Name] integration with GCXONE"
tags:
  - role:installer
...
This guide covers the complete configuration of [Device Name] integration with GCXONE, including both device-side and platform-side setup.

**What you'll accomplish:**
- Configure [device] for communication with GCXONE
...
**Objective**: Ensure [device] can communicate with GCXONE platform.
...
**Objective**: Register the [device] in GCXONE platform.
...
3. Select device type:
   - **Type**: **[Device Type from dropdown]**
...
- [YYYY-MM-DD] v1.0.0 - Initial GCXONE configuration guide
